...
empdata = pd.read_csv("C:/Users/ignac/OneDrive/Documentos/Prueba Chat GPT/Football v2/teams.csv", index_col=False, delimiter=',', encoding='utf8')
...
CREATE TABLE teams (
    ...
    espn_teams VARCHAR(100),
    odds_teams VARCHAR(100)
) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci
"""
cursor.execute(create_table_query)

# Insert the DataFrame data into the table
insert_query = "INSERT INTO teams (team_key, espn_teams, odds_teams) VALUES (%s, %s, %s)"
