...
espn = 'https://espndeportes.espn.com/futbol/resultados/_/fecha/'
...
def fetch(start_date, end_date):
    ...
    while current_date <= end_date:
        ...
        for div in div_tags:
            league = div.find('h3', attrs={'class': 'Card_HeaderTitle CardHeader_Title--no-theme'}).text
...
cursor.execute(sql)
sql='DROP TABLE IF EXISTS heroku_9f69e70d94a5650.football_results_espn'
cursor.execute(sql)
conn.close()
...
table_name = 'football_results_espn'
